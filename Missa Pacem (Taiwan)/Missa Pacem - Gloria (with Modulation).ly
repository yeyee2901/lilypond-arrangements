...
voiceSopran = {
  \relative d' {
    ...
    b4. b4. a4.( a4.) \break
    b4. a4.
    b8( cis8) d8 a4.-\tweak X-offset #8.0 ^\markup{ \box {\bold " 1 = F "} }
    ...
    a4 a8 c4 c8
    b8 a8 g8 a4 a8
    a4. f4 g8-\tweak X-offset #2.5 ^\markup{ \italic "music in. p/mp"}
    a4.( a4) a8\break
    ...
    c4. b4 b8
    a4.( a4.)-\tweak X-offset #-20.5 ^\markup {\italic {"a tempo"} } -\tweak X-offset #18.0 ^\markup{ \box {\bold " 1 = D "} }
    \key d \major
    \break
    ...
    a4.( a4.)-\tweak X-offset #12.0 ^\markup{ \box {\bold " 1 = F "} }
    ...
    d4. c4. \break
    g4.( g4) a8
    c4.^\markup{\italic "cresc."} bes4 bes8
    f4.( f4) g8
    c4. f,4. \break
    bes4.( a4.)
    g4. f4( g8)
    a4.( a4.
    a4. a4.) -\tweak X-offset #10.0 ^\markup{ \box {\bold " 1 = D "} }
    \break
    \key d \major
...
lyricUnisono = \lyricmode {
  ...
  % verse 1
  We prbese _ _ you, we bless _ _ you, _ _
